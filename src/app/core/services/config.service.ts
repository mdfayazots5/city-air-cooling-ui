...
import { SiteConfig, BusinessInfo, Service, ServiceArea, Feature, Testimonial, Faq } from '../models';
...
export class ConfigService {
  private config: SiteConfig = {
    ...
    brands: ['LG', 'Samsung', 'Daikin', 'Hitachi', 'Voltas', 'Blue Star', 'Carrier', 'O General', 'Panasonic', 'Mitsubishi'],
    seo: {
      ...
      keywords: ['AC repair Hyderabad', 'AC service Kukatpally', 'AC installation Hyderabad', 'AC maintenance Hyderabad', 'gas refilling Hyderabad', 'AC AMC Hyderabad', 'best AC service', 'affordable AC repair'],
    ...
    testimonials: [
      { name: 'Rajesh Kumar', location: 'Kukatpally', rating: 5, text: 'Excellent service! The technician arrived on time and fixed my AC within an hour. Highly recommended!' },
      { name: 'Srinivas Rao', location: 'Miyapur', rating: 5, text: 'Very professional team. They provided fair pricing and quality service. Will definitely use again.' },
      { name: 'Pavan Kumar', location: 'Gachibowli', rating: 5, text: 'Best AC service in Hyderabad. Quick response and excellent workmanship.' },
      { name: 'Anil Kumar', location: 'Ameerpet', rating: 5, text: 'Great experience! The AC is working perfectly after repair. Thank you team!' },
      { name: 'Ravi Teja', location: 'Madhapur', rating: 5, text: 'Very satisfied with the AC installation. Professional service at affordable price.' }
    ],
    faqs: [
      { question: 'How often should I service my AC?', answer: 'It is recommended to service your AC at least once a year. Regular maintenance ensures optimal performance and extends the lifespan of your AC unit.' },
      { question: 'Why is my AC not cooling properly?', answer: 'Common reasons include low refrigerant levels, dirty filters, clogged condenser coils, or compressor issues. Our technicians can diagnose and fix the problem.' },
      { question: 'How much does AC repair cost?', answer: 'Repair costs vary depending on the issue. We provide transparent pricing with no hidden charges. Contact us for a free estimate.' },
      { question: 'Do you offer warranty on repairs?', answer: 'Yes, we offer warranty on all our repair services. The warranty period varies depending on the type of repair and parts used.' },
      { question: 'What brands do you service?', answer: 'We service all major brands including LG, Samsung, Daikin, Hitachi, Voltas, Blue Star, Carrier, Panasonic, Mitsubishi, and more.' },
      { question: 'Do you provide emergency AC repair services?', answer: 'Yes, we offer 24/7 emergency services for urgent AC problems. Call us anytime for immediate assistance.' },
      { question: 'How long does AC installation take?', answer: 'Typically, split AC installation takes 2-3 hours. Window AC installation is quicker, usually within 1-2 hours.' },
      { question: 'What is an AMC (Annual Maintenance Contract)?', answer: 'AMC is an annual maintenance contract that covers regular servicing, free repairs, and priority service at a fixed annual cost.' }
    ],
    analytics: {
  ...
  private configSubject = new BehaviorSubject<SiteConfig>(this.config);
  ...
  getWhatsAppUrl(message?: string): string {
    const defaultMessage = 'Hello, I need AC service';
    return `https://wa.me/${this.config.business.whatsapp}?text=${encodeURIComponent(message || defaultMessage)}`;
  }

  getCallUrl(): string {
    return `tel:${this.config.business.phone}`;
  }
}
